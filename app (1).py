...
# Inicializamos el modelo Gemini 1.5 Flash (modelo rápido y gratuito)
...
Si el estudiante comete un error o tiene confusión, explícale pacientemente y sugiera cómo mejorar su razonamiento.
